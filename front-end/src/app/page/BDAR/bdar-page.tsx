    ...
    <Layout style={{ backgroundColor: '#f0f0f0' }}>
      <div className={styles.content}>
        ...
        <section className={styles.textArea}>
          ...
          <h4>
            <b>Registruodamiesi interneto svetainėje <a
              href={'https://java2-menuo-su-it.northeurope.cloudapp.azure.com/'}>https://java2-menuo-su-it.northeurope.cloudapp.azure.com/</a> ir
              mobiliojoje aplikacijoje, Jūs patikite UAB „Mėnuo su IT“ (toliau – Bendrovė, arba mes) savo asmens
